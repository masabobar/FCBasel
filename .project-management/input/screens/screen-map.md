...
| **Status** | *(generated)* In Progress (12/17 completed — US-012 shell, US-013 baseline row, US-014 insertion machinery, US-015 reset, US-016 hero band, US-028 prompt bar, US-029 chips, US-030 matcher, US-031 thinking beat, US-032 fallback/empty panels, US-033 follow-up gating, **US-034 Hero 1 primary**. The conversational layer is complete and the FIRST scripted answer is on screen; five hero-content stories remain) |
...
| **Grown** | One or more hero sections inserted, in the order asked | US-014, US-034 to US-039 | 🔄 Mechanic built (US-014) — sections insert into the canvas grid, dedupe by hero id, reflow and auto-scroll. **US-034 filled Hero 1's content**: three tiles under one narrative and one period filter. Heroes 2 and 3 keep the marked placeholder until US-036 / US-038 |
