...
> Note: the **always-load** [`security-review.md`](security-review.md) triage runs on every story and *routes here* whenever a security trigger fires. `security-and-auth.md` is the conditional deep-dive with the full requirements.
