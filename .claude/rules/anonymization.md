...
- `commands/process-client-docs.md` (primary intake of external personal info)
- `commands/init-project.md` (consumes the same inputs)
- `commands/generate-docs.md`
- `commands/add-scope.md` and `add-bug.md` (when story/bug descriptions reference people)
