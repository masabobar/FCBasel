...
- `commands/add-scope.md` — slash command that enforces this template when adding frontend stories
- `commands/process-client-docs.md` — extracts screens from designs and generates screen-driven stories
- `commands/screen-map.md` — refreshes the consolidated screen map from these stories
